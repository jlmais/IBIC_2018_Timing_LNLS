...
%deleted FIXED in the sentence "...connected to a frequency synthesizer (Texas Instruments CDCM61004) fixed configured to 125~MHz,..."
...
%changed the sentence: "...most of them will be power supplies of quadrupoles and sextupoles of the booster and storage ring."
...
%Changed uTCA to MicroTCA in 3 different parts of the text
...
%Are the 8 AMC also "independently configurable"? If yes, change the text.
% I did not understand the final part of the sentence: "...event receiving and output the trigger with a resolution of one event clock period ($\sim$8~ns), the number of pulses from 1 to 65535 and the pulse polarity level (low to high or high to low)."
...
% "When the both..." change to "when both..."
% At the end of the sentence: "...PI controller gains" or "...PI controller gain"?
...
%changed rms to RMS
% Can we explain why 200 Hz is a good value? Could a reference be mentioned?
